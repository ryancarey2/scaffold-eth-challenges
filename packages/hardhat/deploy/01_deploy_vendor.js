...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const tokenSupply = await yourToken.totalSupply();

  // Todo: transfer the tokens to the vendor
  console.log(`\n 🏵  Sending all ${tokenSupply / (10 ** 18)} tokens to the vendor...\n`);
  ...
  const ownershipTransaction = await vendor.transferOwnership("0x9916870636DA64A65A8bE5CF3c643c0b1B166050" );
  console.log("\n    ✅ confirming...\n");
